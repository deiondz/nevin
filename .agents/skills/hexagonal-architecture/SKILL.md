...
Use kebab-case for file and folder names across examples and generated project structure. Keep language identifiers idiomatic: TypeScript classes and interfaces can stay PascalCase, while functions, variables, and object fields can stay camelCase.
