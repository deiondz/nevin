...
export function AlertDialogMedia({
  ...
  return (
    <div
      className={cn(
        "mx-auto mb-2 flex size-12 items-center justify-center rounded-full bg-muted text-muted-foreground sm:mx-0",
        className,
      )}
...
export function AlertDialogCancel({
  ...
  return (
    <AlertDialogClose render={<Button variant={variant} {...props} />}>
      {children}
    </AlertDialogClose>
  );
}
